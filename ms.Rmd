...
Examples of subject specific frameworks are found within the Bioinformatics community, for example the Bioconductor infrastructure that uses R (@Gentleman2004, www.bioconductor.org), and BioJS, a repository for JavaScript components (@Corpas2014, www.biojs.net).
...
In terms of robustness, the CHASTE project for cardiac modelling (@Mirams2013, www.cs.ox.ac.uk/chaste) has developed into a model repository that offers community benchmarks for the last 50 years of cardiac modelling [@Cooper2016].
