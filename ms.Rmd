...
The ZOON project takes a different approach, defining only the core architecture of workflows, and interfacing with an open repository of community-contributed software modules.
