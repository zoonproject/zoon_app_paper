...
zoon enables us to investigate this hypothesis by fitting MaxEnt models with and without regularisation and feature construction.
...
names(AUCs) <- c('MaxEnt',
                 ...
                 'MaxNet (linear features)',
                 'MaxNet (linear features and no regularization)',
                 'Logistic regression')
