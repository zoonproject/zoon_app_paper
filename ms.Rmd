...
```{r plotzoonoverview, echo = FALSE, fig.height = 9, dpi = 300, fig.cap = pzocap}
...
```{r fengworkflow, eval = TRUE, results = 'hide', fig.show = 'hide', message = FALSE}
Feng_Papes <- 
...
![Map of the presence data (red), background data (black) and the MaxEnt relative probability of occurrence (darker blue showing higher probability of occurrence). White areas are masked due to being marine in the marine environment or due to the MESS mask.\label{fig:fengmap](./figs/fengworkflow-1.png)
